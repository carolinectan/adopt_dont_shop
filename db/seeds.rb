...
# pet_applications
pa_1 = PetApplication.create!(pet: bosco, application: app_1)
pa_2 = PetApplication.create!(pet: lily, application: app_1)
pa_3 = PetApplication.create!(pet: leia, application: app_2)
pa_4 = PetApplication.create!(pet: beans, application: app_3)
pa_5 = PetApplication.create!(pet: izze, application: app_4)
pa_6 = PetApplication.create!(pet: zephyr, application: app_5)
pa_7 = PetApplication.create!(pet: ruger, application: app_4)
pa_8 = PetApplication.create!(pet: clyde, application: app_3)
pa_9 = PetApplication.create!(pet: jasmine, application: app_6)
pa_10 = PetApplication.create!(pet: finn, application: app_2)
